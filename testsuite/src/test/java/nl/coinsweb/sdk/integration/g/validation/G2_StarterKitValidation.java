package nl.coinsweb.sdk.integration.g.validation;
...
public class G2_StarterKitValidation {
  ...
  public void readRdfFile_2_01() {
    ...
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.01_inmem.ccr"), false);
  ...
  public void readRdfFile_2_02() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.02_inmem.ccr"), false);
  ...
  public void readRdfFile_2_03() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.03_inmem.ccr"), false);
  ...
  public void readRdfFile_2_04() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.04_inmem.ccr"), false);
  ...
  public void readRdfFile_2_05() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.05_inmem.ccr"), false);
  ...
  public void readRdfFile_2_06() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.06_inmem.ccr"), false);
  ...
  public void readRdfFile_2_07() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.07_inmem.ccr"), false);
  ...
  public void readRdfFile_2_08() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.08_inmem.ccr"), false);
  ...
  public void readRdfFile_2_09() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.09_inmem.ccr"), false);
  ...
  public void readRdfFile_2_10() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.10_inmem.ccr"), false);
  ...
  public void readRdfFile_2_11() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.11_inmem.ccr"), false);
  ...
  public void readRdfFile_2_12() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit2.12_inmem.ccr"), false);
  ...
  public void readRdfFile_3_01() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit3.01_inmem.ccr"), false);
  ...
  public void readRdfFile_3_02() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit3.02_inmem.ccr"), false);
  ...
  public void readRdfFile_3_03() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit3.03_inmem.ccr"), false);
  ...
  public void readRdfFile_3_04() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit3.04_inmem.ccr"), false);
  ...
  public void readRdfFile_4_01() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "starterskit4.01_inmem.ccr"), false);
...
//  @Test
  public void readRdfFile_performanceCheck() {
    ...
    JenaCoinsContainer model = new JenaCoinsContainer();
    model.load(IntegrationHelper.getResourceFile("G2", "PerformanceContainerCOINS2.0.ccr"), false);
